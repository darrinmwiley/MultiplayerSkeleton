...
public class Edge
{
    ...
    {
        return Intersects(p.previous, p.position);
    }

    public bool Intersects(Vector2 prevLoc, Vector2 nextLoc)
    {
        Vector2 intersection;
        return LineUtil.IntersectLineSegments2D(p1.position, p2.position, prevLoc, nextLoc, out intersection);
    }
